...
public class PhoneBillCalculatorTest {
    ...
    public void testCallCostWithTwentyMinutes() {
        double cost = PhoneBillCalculator.calculateCallCost(23 * 60);
        Assertions.assertEquals(1.30, cost, 0.001);
    }
    ...
    public void testCallCostWithSixtyOneMinutes() {
        double cost = PhoneBillCalculator.calculateCallCost(63 * 60);
        Assertions.assertEquals(5.30, cost, 0.001);
    }
}
